...
namespace gpufmt {
    ...
    public:
        static constexpr FormatInfo info = FormatInfo{
            ...
            GF_DI(.channels = ) ChannelMask::None,
            GF_DI(.redBitMask = ) 0,
            GF_DI(.greenBitMask = ) 0,
            GF_DI(.blueBitMask = ) 0,
            GF_DI(.alphaBitMask = ) 0,
            GF_DI(.redIndex = ) kInvalidChannelIndex,
            GF_DI(.greenIndex = ) kInvalidChannelIndex,
            GF_DI(.blueIndex = ) kInvalidChannelIndex,
            GF_DI(.alphaIndex = ) kInvalidChannelIndex,
    ...
    public:
        static constexpr FormatInfo info = FormatInfo {
            ...
            GF_DI(.decompressedFormatAlt =) gpufmt::Format::UNDEFINED,
            GF_DI(.supportedApis =) GraphicsApi::OpenGL | GraphicsApi::Vulkan,
            GF_DI(.channels =) ChannelMask::RGBA,
    ...
    public:
        static constexpr FormatInfo info = FormatInfo{
            ...
            GF_DI(.channels =) ChannelMask::RGB,
    ...
    public:
        static constexpr FormatInfo info = FormatInfo {
            ...
            GF_DI(.decompressedFormatAlt =) gpufmt::Format::UNDEFINED,
            GF_DI(.supportedApis =) GraphicsApi::DirectX11 | GraphicsApi::DirectX12 | GraphicsApi::OpenGL | GraphicsApi::Vulkan,
            GF_DI(.channels =) ChannelMask::Red,
    ...
    public:
        static constexpr FormatInfo info = FormatInfo{
            ...
            GF_DI(.decompressedFormatAlt =) gpufmt::Format::UNDEFINED,
            GF_DI(.supportedApis =) GraphicsApi::DirectX11 | GraphicsApi::DirectX12 | GraphicsApi::OpenGL,
            GF_DI(.channels =) ChannelMask::Alpha,
            GF_DI(.redBitMask = ) 0,
            GF_DI(.greenBitMask = ) 0,
            GF_DI(.blueBitMask = ) 0,
    ...
    public:
        static constexpr FormatInfo info = FormatInfo{
            ...
            GF_DI(.supportedApis =) GraphicsApi::OpenGL | GraphicsApi::Vulkan,
            GF_DI(.channels =) ChannelMask::RGB,
            GF_DI(.redBitMask = ) {16, 0},
            GF_DI(.greenBitMask = ) {16, 16},
            GF_DI(.blueBitMask = ) {16, 32},
            GF_DI(.alphaBitMask = ) 0,
            GF_DI(.redIndex   =) 0u,
            GF_DI(.greenIndex =) 1u,
            GF_DI(.blueIndex  =) 2u,
    ...
    public:
        static constexpr FormatInfo info = FormatInfo{
            ...
            GF_DI(.supportedApis =)  GraphicsApi::DirectX11 | GraphicsApi::DirectX12 | GraphicsApi::OpenGL | GraphicsApi::Vulkan,
            GF_DI(.channels =) ChannelMask::RG,
            GF_DI(.redBitMask = ) {32, 0},
            GF_DI(.greenBitMask = ) {32, 32},
            GF_DI(.blueBitMask = ) 0,
            GF_DI(.alphaBitMask = ) 0,
            GF_DI(.redIndex =) 0u,
            GF_DI(.greenIndex =) 1u,
    ...
    public:
        static constexpr FormatInfo info = FormatInfo{
            ...
            GF_DI(.decompressedFormatAlt =) gpufmt::Format::UNDEFINED,
            GF_DI(.supportedApis =) GraphicsApi::DirectX11 | GraphicsApi::DirectX12 | GraphicsApi::OpenGL | GraphicsApi::Vulkan,
            GF_DI(.channels =) ChannelMask::Depth,
            GF_DI(.redBitMask = ) 0,
            GF_DI(.greenBitMask = ) 0,
            GF_DI(.blueBitMask = ) 0,
            GF_DI(.alphaBitMask = ) 0,
    ...
    public:
        static constexpr FormatInfo info = FormatInfo{
            ...
            GF_DI(.decompressedFormatAlt =) gpufmt::Format::UNDEFINED,
            GF_DI(.supportedApis =) GraphicsApi::OpenGL | GraphicsApi::Vulkan,
            GF_DI(.channels =) ChannelMask::Stencil,
            GF_DI(.redBitMask = ) 0,
            GF_DI(.greenBitMask = ) 0,
            GF_DI(.blueBitMask = ) 0,
            GF_DI(.alphaBitMask = ) 0,
    ...
    public:
        static constexpr FormatInfo info = FormatInfo{
            ...
            GF_DI(.decompressedFormatAlt =) gpufmt::Format::UNDEFINED,
            GF_DI(.supportedApis =) GraphicsApi::OpenGL | GraphicsApi::Vulkan,
            GF_DI(.channels =) ChannelMask::DepthStencil,
            GF_DI(.redBitMask = ) 0,
            GF_DI(.greenBitMask = ) 0,
            GF_DI(.blueBitMask = ) 0,
            GF_DI(.alphaBitMask = ) 0,
